...
class SettingsFrame1(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.open_comments_button = tk.Button(self.sliders_frame,
        ...
        self.comments_text_field_frame = tk.Frame(self, bg="black", height=495, width=1170, highlightbackground="black", highlightcolor="black", highlightthickness=2,)

        self.comments_text_field = tk.Text(self.comments_text_field_frame, bg="white", font=("Helvetica", 12), fg="black", height=24, width=129)
        self.comments_text_field.place(x=0, y=0)

        self.save_comments_button = tk.Button(self.comments_text_field_frame, text="SAVE COMMENTS", bg="#24D215", fg="white", font=font_used, height=2, width=20, command=self.save_comments_input)
